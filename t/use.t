...
require_ok 'Dist::Zilla::MintingProfile::Clustericious';
require_ok 'Dist::Zilla::Plugin::CSS::Compressor';
require_ok 'Dist::Zilla::Plugin::InsertExample';
require_ok 'Dist::Zilla::Plugin::JavaScript::Minifier';
require_ok 'Dist::Zilla::Plugin::jQuery';
require_ok 'Dist::Zilla::Plugin::MathInt64';
require_ok 'Dist::Zilla::Plugin::Template::Tiny';
require_ok 'Dist::Zilla::Plugin::TextTabs';
require_ok 'Dist::Zilla::Plugin::TwitterBootstrap';
